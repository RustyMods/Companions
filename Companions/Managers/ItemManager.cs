...
public class Item
{
	...
	public static Dictionary<Item, Dictionary<string, List<Recipe>>> activeRecipes = new();
	...
	public static Dictionary<Item, Dictionary<string, ItemConfig>> itemCraftConfigs = new();
	public static Dictionary<Item, ConfigEntry<string>> itemDropConfigs = new();
	private Dictionary<CharacterDrop, CharacterDrop.Drop> characterDrops = new();
	public readonly Dictionary<ConfigEntryBase, Action> statsConfigs = new();
	...
	public delegate void setDmgFunc(ref HitData.DamageTypes dmg, float value);
	...
	public void InitializeNewRegisteredItem()
	{
	...
	public void ReloadTraderConfiguration()
	{
	...
	public void registerRecipesInObjectDB(ObjectDB objectDB)
	{
	...
	public static Action<ConfigEntryBase> drawRequirementsConfigTable(Item item, bool isUpgrade)
	{
		return cfg =>
		{
	...
	public static void drawDropsConfigTable(ConfigEntryBase cfg)
	{
		bool locked = cfg.Description.Tags.Select(a => a.GetType().Name == "ConfigurationManagerAttributes" ? (bool?)a.GetType().GetField("ReadOnly")?.GetValue(a) : null).FirstOrDefault(v => v != null) ?? false;
